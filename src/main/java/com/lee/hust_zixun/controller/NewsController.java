...
import com.lee.hust_zixun.model.*;
import com.lee.hust_zixun.service.*;
...
public class NewsController {
    ...
    public void getImage(@RequestParam("name") String imageName,
        ...
        try {
            ...
            StreamUtils.copy(new FileInputStream(new
                    File(ZiXunUtil.IMAGE_DIR + imageName)), response.getOutputStream());
        } catch (Exception e) {
    ...
    public String addNews(@RequestParam("image") String image,
        ...
        try {
            ...
            return ZiXunUtil.getJSONString(1, "发布失败");
        }
    }
}
